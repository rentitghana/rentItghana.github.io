...
var AWSS3Provider = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        s3.middlewareStack.remove(StorageConstants_1.SET_CONTENT_LENGTH_HEADER);
                        _c.label = 2;
                    case 2:
                        _c.trys.push([2, 4, , 5]);
    ...
    AWSS3Provider.prototype._createNewS3Client = function (config, emitter) {
        ...
        var s3client = new client_s3_1.S3Client(__assign(__assign({ region: region, 
            ...
            credentials: this._credentialsProvider, customUserAgent: core_1.getAmplifyUserAgent() }, localTestingConfig), { requestHandler: new axios_http_handler_1.AxiosHttpHandler({}, emitter, cancelTokenSource) }));
        return s3client;
    };
